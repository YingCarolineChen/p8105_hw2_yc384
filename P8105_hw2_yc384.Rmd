...
From the above steps, we can see that the values for variable "Child's First Name" are not consistant. Some names were capitalized only with the first letter. Some names are all entered as upper case. In order to be consistent, we need to change the names to upper case. 
